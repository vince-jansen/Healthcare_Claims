...
# The linear model R^2 = 74.88%, MAE = $4,197
# The Tensorflow model R^2 ~ 81.5%, MAE ~ $3,200
# The Pyrenn model R^2 ~ 84.5%, MAE ~ $2,800
print('The overall OLS model R^2 is' ,np.corrcoef(all_linear_predictions.T,Y_data.T)[0,1]**2)
print('The overall OLS model MAE is' ,np.mean(np.abs(all_linear_predictions.T-Y_data.T)))
print('The overall Tensorflow model R^2 is' ,np.corrcoef(all_nn_predictions.T,Y_data.T)[0,1]**2)
print('The overall Tensorflow model MAE is' ,np.mean(np.abs(all_nn_predictions.T-Y_data.T)))
print('The overall Pyrenn model R^2 is' ,np.corrcoef(all_LM_predictions.T,Y_data.T)[0,1]**2)
print('The overall Pyrenn model MAE is' ,np.mean(np.abs(all_LM_predictions.T-Y_data.T)))
